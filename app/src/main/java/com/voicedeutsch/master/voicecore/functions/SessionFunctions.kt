            ...
            parameters = GeminiParameters(
                properties = mapOf(
                    "strategy" to GeminiProperty(
                        type = "string",
                        description = "Стратегия обучения",
                        enum = listOf(
                            "REPETITION", "LINEAR_BOOK", "FREE_PRACTICE",
                            "PRONUNCIATION", "GAP_FILLING", "GRAMMAR_DRILL",
                            "VOCABULARY_BOOST", "LISTENING", "ASSESSMENT"
                        ),
                    ),
                    "reason" to GeminiProperty(type = "string", description = "Причина переключения"),
                ),
